...
class JevApiError(JevError):
    ...
    HINTS = {
        ...
        401: "Bad or missing API key. Set OPENROUTER_API_KEY.",
        402: "Out of OpenRouter credits. Top up at openrouter.ai/credits, or fall back to the plain LLM path.",
        403: "Key lacks access to this model.",
        404: "Wrong endpoint. Jev uses /api/alpha/decisions, never /api/v1/chat/completions.",
        413: "State too large for the 32K context window. Chunk it, or prefilter with code.",
        ...
        529: "Provider overloaded. Retry with backoff, or fall back to the LLM path.",
    }
